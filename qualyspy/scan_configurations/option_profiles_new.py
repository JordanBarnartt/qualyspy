...
class Option_Profiles:
    option_profile: Optional[MutableSequence[Option_Profile]] = None
...
class System_Auth_Record:
    allow_auth_creation: Optional[str] = None
    include_system_auth: Optional[str] = None
...
class Block_Resources:
    watchguard_default_block_ports: Optional[str] = None
